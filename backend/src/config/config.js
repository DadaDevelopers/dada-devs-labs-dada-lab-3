...
const SMTP_FROM = process.env.SMTP_FROM || process.env.MAILTRAP_FROM || "";
...
export default {
  ...
  ACCESS_EXPIRES_IN: process.env.ACCESS_EXPIRES_IN || "7d",
  ...
  FRONTEND_URL: normalize(process.env.FRONTEND_URL || ""),
